...
@Component({
  selector: 'app-video-form-field',
  templateUrl: './video-form-field.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => VideoFormFieldComponent),
      multi: true,
    },
  ],
})
export class VideoFormFieldComponent
