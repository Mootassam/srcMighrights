...
@Component({
  selector: 'app-audio-form-field',
  templateUrl: './audio-form-field.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AudioFormFieldComponent),
      multi: true,
    },
  ],
})
export class AudioFormFieldComponent
