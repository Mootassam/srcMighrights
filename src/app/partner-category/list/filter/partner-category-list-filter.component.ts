...
@Component({
  selector: 'app-partner-category-list-filter',
  templateUrl: './partner-category-list-filter.component.html',
})
export class PartnerCategoryListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: PartnerCategoryListService,
