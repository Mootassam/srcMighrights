...
import partnerCategoryExporterFields from 'src/app/partner-category/list/partner-category-exporter-fields';
...
export class PartnerCategoryListService {
  rows = [];
  count = 0;
  loading = false;
  filter: any = {};
  ...
  async doExport() {
    try {
      ...
      const response = await PartnerCategoryApi.list(
        filter,
        this.orderBy,
        null,
        null,
